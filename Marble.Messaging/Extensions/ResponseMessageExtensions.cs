...
namespace Marble.Messaging.Extensions
{
    ...
    {
        public static RemoteMessage ToRemoteMessage(this ResponseMessage responseMessage, RequestMessageContext messageContext, ISerializationAdapter serializationAdapter)
        {
