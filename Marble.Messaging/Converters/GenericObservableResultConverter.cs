...
namespace Marble.Messaging.Converters
{
    public class GenericObservableResultConverter : IResultConverter
    {
        ...
        {
            if (genericTypeArgument == typeof(object))
            {
        ...
        private IObservable<object> ConvertValueTypeBasedObservableToObjectObservable(object result, Type genericTypeArgument)
        {
